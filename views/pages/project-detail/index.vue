      ...
      columns: [
        ...
        { title: '描述', ellipsis: true, key: 'description' },
        {
          ...
          render: (h, params) => {
            ...
            let switchAddressButton = <i-button size="small" title="切换地址" class="switch-address" onClick={this.switchAuthentic.bind(this, params.row)}><icon type={switchAddressIcon}></icon></i-button>
